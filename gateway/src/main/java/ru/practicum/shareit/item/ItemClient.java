...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> getById(Integer userId, Long itemId) {
    ...
    public ResponseEntity<Object> update(Integer userId, Long itemId, ItemDto itemDto) {
        return patch("/" + itemId, userId, itemDto);
    }

    public ResponseEntity<Object> delete(Integer userId, Integer itemId) {
